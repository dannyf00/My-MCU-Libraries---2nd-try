...
void tmra0_act(void (*isr_ptr)(void)) {
...
//install user handler for timer_a, ccr1
void tmra0_act5(void (*isr_ptr)(void)) {
...
//install user handler for timer_a, ccr1
void tmra0_act6(void (*isr_ptr)(void)) {
