...
#define TAxCCTL0			TA2CCTL0		//timer0 compare control
#define TAxCCTL1			TA2CCTL1		//timer1 cmpare control
#define TAxCCTL2			TA2CCTL2		//timer2 compare control
#define TAxCCTL3			TA2CCTL3		//timer0 compare control
#define TAxCCTL4			TA2CCTL4		//timer1 cmpare control
#define TAxCCTL5			TA2CCTL5		//timer2 compare control
#define TAxCCTL6			TA2CCTL6		//timer0 compare control
#define TAxCCR0				TA2CCR0			//timer0 compare register
#define TAxCCR1				TA2CCR1			//timer1 compare register
#define TAxCCR2				TA2CCR2			//timer2 compare register
#define TAxCCR3				TA2CCR3			//timer0 compare register
#define TAxCCR4				TA2CCR4			//timer1 compare register
#define TAxCCR5				TA2CCR5			//timer2 compare register
#define TAxCCR6				TA2CCR6			//timer0 compare register
...
__interrupt void _ISRTimer2_A0 (void) {
...
void tmra2_act(void (*isr_ptr)(void)) {
...
void tmra2_act0(void (*isr_ptr)(void)) {
...
void tmra2_act1(void (*isr_ptr)(void)) {
...
//install user handler for timer_a, ccr1
void tmra2_act2(void (*isr_ptr)(void)) {
...
//install user handler for timer_a, ccr1
void tmra2_act3(void (*isr_ptr)(void)) {
...
//install user handler for timer_a, ccr1
void tmra2_act4(void (*isr_ptr)(void)) {
...
//install user handler for timer_a, ccr1
void tmra2_act5(void (*isr_ptr)(void)) {
...
//install user handler for timer_a, ccr1
void tmra2_act6(void (*isr_ptr)(void)) {
