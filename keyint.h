#ifndef KEYINT_H_INCLUDED
#define KEYINT_H_INCLUDED

//generic switch / key debouncing routines, using Kenneth Kuhn's integrator
...
#define CNT_MAX								10	//max number of keys
...
typedef enum {
	...
	KEY_DOUBLEPRESSED,							//key double pressed
...
typedef struct {
	...
	int cnt_key;								//counter for current state / integrator
