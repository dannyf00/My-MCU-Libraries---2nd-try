...
#define PWM_TA0CH1()				do {IO_OUT(PORT1, 1<<0); IO_AF1(PORT1, 1<<0);} while (0)	//CH1 output on P1.0, AF1
#define PWM_TA0CH2()				do {IO_OUT(PORT1, 1<<1); IO_AF1(PORT1, 1<<1);} while (0)	//CH2 output on P1.1, AF1
...
#define pwmta0_setdc1(dc)	TIMERA0->CCR1 = (dc)
#define pwmta0_setdc2(dc)	TIMERA0->CCR2 = (dc)
