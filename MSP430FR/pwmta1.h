...
#define PWM_TA1CH1()				do {IO_OUT(PORT1, 1<<2); IO_AF1(PORT1, 1<<2);} while (0)	//CH1 output on P1.2, AF1
#define PWM_TA1CH2()				do {IO_OUT(PORT1, 1<<3); IO_AF1(PORT1, 1<<3);} while (0)	//CH2 output on P1.3, AF1
...
#define pwmta1_setdc1(dc)	TIMERA1->CCR1 = (dc)
#define pwmta1_setdc2(dc)	TIMERA1->CCR2 = (dc)
