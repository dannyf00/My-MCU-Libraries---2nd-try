#include "tim12.h"					//using timer output compare channels as timer
...
//global defines
#define TIMx							TIM12
#define TIMx_IRQn						TIM8_BRK_TIM12_IRQn
...
void tim12_act(void (*isr_ptr)(void)) {
