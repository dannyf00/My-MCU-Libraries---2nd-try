...
#include "pwm5.h"                    //header file for f0_pwm1
...
#endif
#define _OCTSELx 					OC5CONbits.OCTSEL
#define _OCMx 						OC5CONbits.OCM
#define _OCxON						OC5CONbits.ON
#define OCxR						OC5R		//compare register
#define OCxRS						OC5RS		//period register
#define _OCxMD						PMD3bits.OC5MD		//power management register
