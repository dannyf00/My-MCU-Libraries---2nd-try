...
#include "pwm3.h"                    //header file for f0_pwm1
...
#endif
#define _OCTSELx 					OC3CONbits.OCTSEL
#define _OCMx 						OC3CONbits.OCM
#define _OCxON						OC3CONbits.ON
#define OCxR						OC3R		//compare register
#define OCxRS						OC3RS		//period register
#define _OCxMD						PMD3bits.OC3MD		//power management register
