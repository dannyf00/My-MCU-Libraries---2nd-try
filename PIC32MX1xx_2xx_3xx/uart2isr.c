...
//pinconfiguration
#define UxTX2RP()			PPS_RPB0_TO_U2TX()			//u1tx pin
#define UxRX2RP()			PPS_U2RX_TO_RPA1()			//rx pin
//end pin configuration

//for U1ART
#define UxMD				PMD5bits.U2MD		//power management bit
#define UxMODE				U2MODEbits	//mode register
#define UxBRG				U2BRG		//baud rate generator
#define UxSTA				U2STAbits	//status register
#define UxTXIE				IEC1bits.U2TXIE		//interrupt enable bit
#define UxTXIF				IFS1bits.U2TXIF		//interrupt flag
#define UxRXIE				IEC1bits.U2RXIE		//interrupt enable bit
#define UxRXIF				IFS1bits.U2RXIF		//interrupt flag
#define UxTXREG				U2TXREG		//transmission data register
#define UxRXREG				U2RXREG		//transmission data register
#define UxIP				IPC9bits.U2IP		//t1 interrupt priority
#define UxIS				IPC9bits.U2IS		//t1 interrupt sub-priority
#define UxIPL				IPL3				//default isr priority levels
#define UxIP_DEFAULT		3					//default interrupt priority - lowest
