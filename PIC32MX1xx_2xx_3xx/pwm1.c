...
#include "pwm1.h"                    //header file for f0_pwm1
...
#endif
#define _OCTSELx 					OC1CONbits.OCTSEL
#define _OCMx 						OC1CONbits.OCM
#define _OCxON						OC1CONbits.ON
#define OCxR						OC1R		//compare register
#define OCxRS						OC1RS		//period register
#define _OCxMD						PMD3bits.OC1MD		//power management register
