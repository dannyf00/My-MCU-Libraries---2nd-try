...
#include "pwm2.h"                    //header file for f0_pwm1
...
#endif
#define _OCTSELx 					OC2CONbits.OCTSEL
#define _OCMx 						OC2CONbits.OCM
#define _OCxON						OC2CONbits.ON
#define OCxR						OC2R		//compare register
#define OCxRS						OC2RS		//period register
#define _OCxMD						PMD3bits.OC2MD		//power management register
