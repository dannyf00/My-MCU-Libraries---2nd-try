#include "uartoc4isr.h"							//we use softwar uart 1 on Output Compare
...
//use OC4..5
#define OCxMD				PMD2bits.OC4MD
#define OCxCON1				OC4CON1
#define OCxCON2				OC4CON2
#define OCxR				OC4RS
#define OCxTMR				OC4TMR
#define OCxIF				IFS1bits.OC4IF		//interrupt flag
#define OCxIE				IEC1bits.OC4IE		//interrupt enable
