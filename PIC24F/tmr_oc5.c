...
#include "tmroc5.h"						//using oc2 as timer
...
#define OCxTMR						OC5TMR		//oc2 timer
#define _OCxIF						_OC5IF		//interrupt flag
#define _OCxIE						_OC5IE		//interrupt enable
...
void tmroc5_init(unsigned short ps, unsigned short period) {
