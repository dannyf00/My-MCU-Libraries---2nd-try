...
#include "tmroc2.h"						//using oc2 as timer
...
#define OCxTMR						OC2TMR		//oc2 timer
#define _OCxIF						_OC2IF		//interrupt flag
#define _OCxIE						_OC2IE		//interrupt enable
...
void tmroc2_init(unsigned short ps, unsigned short period) {
