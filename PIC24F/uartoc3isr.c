#include "uartoc3isr.h"							//we use softwar uart 1 on Output Compare
...
//use OC1..5
#define OCxMD				PMD2bits.OC3MD
#define OCxCON1				OC3CON1
#define OCxCON2				OC3CON2
#define OCxR				OC3RS
#define OCxTMR				OC3TMR
#define OCxIF				IFS1bits.OC3IF		//interrupt flag
#define OCxIE				IEC1bits.OC3IE		//interrupt enable
