...
#include "tmroc1.h"						//using oc1 as timer
...
#define OCxTMR						OC1TMR		//oc2 timer
#define _OCxIF						_OC1IF		//interrupt flag
#define _OCxIE						_OC1IE		//interrupt enable
...
void tmroc1_init(unsigned short ps, unsigned short period) {
