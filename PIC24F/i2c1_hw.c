//#include <p24fxxxx.h>
//#include "gpio.h"
#include "i2c1_hw.h"						//we use hardware i2c1
...
//i2c_sw interface
//*************************************************************
#define I2Cx_BRG16				((F_CPU / F_I2C1) - (F_CPU / 10000000ul) -1 + 2)	//brg generator value. minimum of 2

//change this section if not using I2C1
#define I2Cx_CEN				I2C1CONbits.I2CEN		//enable i2c
#define I2Cx_A10M				I2C1CONbits.A10M		//1=10 bits, 0=7 bits
#define I2Cx_BRG				I2C1BRG					//baud rate generator
#define I2Cx_SEN				I2C1CONbits.SEN			//sen, send a start condition
#define I2Cx_RSEN				I2C1CONbits.RSEN		//rsen, send a restart condition
#define I2Cx_PEN				I2C1CONbits.PEN			//pen, send a stop condition
#define I2Cx_RCEN				I2C1CONbits.RCEN		//enable master receive
#define I2Cx_TRSTAT				I2C1STATbits.TRSTAT		//transmission status bit. 1=transmission in progress. 0=transmission complete
#define I2Cx_TBF				I2C1STATbits.TBF		//transmission buffer full status bit. 1=transmission in progress. 0=transmission complete
#define I2Cx_RBF				I2C1STATbits.RBF		//transmission receiver buffer full status bit. 1=transmission in progress. 0=transmission complete
#define I2Cx_TRN				I2C1TRN					//i2c data buffer
#define I2Cx_ACKSTAT			I2C1STATbits.ACKSTAT	//i2c ack bit
#define I2Cx_ACKDT				I2C1CONbits.ACKDT		//ack knowledge bit. 1=send i2c_nack; 0=send i2c_ack
#define I2Cx_ACKEN				I2C1CONbits.ACKEN		//ack knowledge enable bit. 1=sending ack bit; 0=done sending ack bit
#define I2Cx_RCV				I2C1RCV					//data received
#define I2Cx_I2COV				I2C1STATbits.I2COV		//i2c receiver overflow
#define I2Cx_MD					_I2C1MD							//enable power to i2c1
...
void i2c1_init(void) {
	...
	I2Cx_BRG = I2Cx_BRG16;					//set the baud rate
...
unsigned char i2c1_write(unsigned char dat) {
	...
	while (I2Cx_TRSTAT) continue;			//wait for the transmission to end
...
#define i2c1_delay(n)		{NOP();NOP();NOP();NOP();NOP();/**/}
