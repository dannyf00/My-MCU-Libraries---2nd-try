...
//#include "gpio.h"
#include "spi2_hw.h"						//we use hardware spi2

//hardware configuration
//end hardware configuration

#define _SPIxMD				_SPI2MD
#define _SPIxIF				_SPI2IF
#define _SPIxIE				_SPI2IE
#define SPIxBUF				SPI2BUF
#define SPIxCON1			SPI2CON1
#define SPIxCON2			SPI2CON2
#define SPIxSTAT			SPI2STAT
#define _SPIxTBF			SPI2STATbits.SPITBF
#define _SPIxRBF			SPI2STATbits.SPIRBF
...
unsigned char spi2_write_read(unsigned char dat) {
