#include "timer3.h"									//use timer3

//hardware configuration
//end hardware configuration

//global defines
#define TMRx				TIMER3					//current timer
...
void tmr3a_init(uint32_t ps, uint32_t pr) {
	...
	//route the clock
	SYSCTL->RCGCTIMER |= (1<<3);						//1->route clock. TIMER0/1/2/3/4/5
...
void tmr3b_act(void (*isrptr)(void)) {
	...
	NVIC_EnableIRQ(TIMER3B_IRQn);					//use default priorities
}
