...
//U1TX=PB1, U1RX=PB0
#define UART1_TX()			do {GPIOB->DEN |= (1<<1); GPIOB->AFSEL |= (1<<1); GPIOB->PCTL = (GPIOB->PCTL &~(0x0f << (1*4))) | (0x01 << (1*4));} while (0)
#define UART1_RX()			do {GPIOB->DEN |= (1<<0); GPIOB->AFSEL |= (1<<0); GPIOB->PCTL = (GPIOB->PCTL &~(0x0f << (0*4))) | (0x01 << (0*4));} while (0)
