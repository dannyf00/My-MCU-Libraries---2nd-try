...
void tim2oc1_setpr(uint16_t pr);			//set output compare 1 period
void tim2oc1_act(void (*isr_ptr)(void));	//activate user handler
void tim2oc2_setpr(uint16_t pr);			//set output compare 1 period
void tim2oc2_act(void (*isr_ptr)(void));	//activate user handler
void tim2oc3_setpr(uint16_t pr);			//set output compare 1 period
void tim2oc3_act(void (*isr_ptr)(void));	//activate user handler
