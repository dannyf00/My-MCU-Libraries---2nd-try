//STM8S device header file for SDCC
//mostly based on the STM8s file repurposed from the STM8S SPL package
//IRQn declared in GPIO.H
//version 0.1@6/24/2018
