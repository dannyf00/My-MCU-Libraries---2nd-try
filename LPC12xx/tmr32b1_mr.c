...
#include "tmr32b1_mr.h"				//we use tmr16b0

//hardware configuration
//end hardware configuration

//global defines
#define CTx				LPC_CT32B1	//16bix timer0
...
void tmr32b1_init(uint32_t prescaler) {
	...
	CTx->PR = (prescaler-1)/* & 0xffff*/;				//set up the 32-bit prescaler register
...
void tmr32b1_setpr0(uint32_t match/*, uint32_t config*/) {
