...
//hardware configuration
	...
	//tmr32b1_match0(TMR32B_1ms, CTxMR_EINT | CTxMR_RESET);				//set match/reset and enable interrupt = overflow isr
	//tmr32b1_act0(led_set);
	//tmr32b1_match3(TMR32B_1ms / 20, CTxMR_EINT);				//set match and enable interrupt
