...
//global defines
#define TAxCTL			TIMER_A1->CTL		//timer a0 control register
#define TAxR			TIMER_A1->R			//timer counter
#define TAxEX0			TIMER_A1->EX0		//expansion divider
#define TAxIV			TIMER_A1->IV		//status register

//compare control registers
#define TAxCCTL0		TIMER_A1->CCTL[0]	//timer a0 ccr0 control register
#define TAxCCTL1		TIMER_A1->CCTL[1]	//timer a0 ccr1 control register
#define TAxCCTL2		TIMER_A1->CCTL[2]	//timer a0 ccr1 control register
#define TAxCCTL3		TIMER_A1->CCTL[3]	//timer a0 ccr1 control register
#define TAxCCTL4		TIMER_A1->CCTL[4]	//timer a0 ccr1 control register
#define TAxCCTL5		TIMER_A1->CCTL[5]	//timer a0 ccr1 control register
#define TAxCCTL6		TIMER_A1->CCTL[6]	//timer a0 ccr1 control register
//compare period registers
#define TAxCCR0			TIMER_A1->CCR[0]	//timer a0 ccr0 period register
#define TAxCCR1			TIMER_A1->CCR[1]	//timer a0 ccr1 period register
#define TAxCCR2			TIMER_A1->CCR[2]	//timer a0 ccr1 period register
#define TAxCCR3			TIMER_A1->CCR[3]	//timer a0 ccr0 period register
#define TAxCCR4			TIMER_A1->CCR[4]	//timer a0 ccr1 period register
#define TAxCCR5			TIMER_A1->CCR[5]	//timer a0 ccr1 period register
#define TAxCCR6			TIMER_A1->CCR[6]	//timer a0 ccr0 period register
...
void tmra1_act0(void (*isrptr)(void)) {
	_tmrx_ccr0isrptr = isrptr;		//install user handler
	TAxCCTL0 |= (1<<4);				//enable interrupt
	NVIC_EnableIRQ(TA1_0_IRQn);		//enable interrupt for timer0_ccr0
}
...
void tmra1_act1(void (*isrptr)(void)) {
	_tmrx_ccr1isrptr = isrptr;		//install user handler
	TAxCCTL1 |= (1<<4);				//enable interrupt
	NVIC_EnableIRQ(TA1_N_IRQn);		//enable interrupt for timer0_ccr0
}
...
void tmra1_act2(void (*isrptr)(void)) {
...
void tmra1_act3(void (*isrptr)(void)) {
...
void tmra1_act4(void (*isrptr)(void)) {
...
void tmra1_act5(void (*isrptr)(void)) {
...
void tmra1_act6(void (*isrptr)(void)) {
