...
//global defines
#define TAxCTL			TIMER_A0->CTL		//timer a0 control register
#define TAxR			TIMER_A0->R			//timer counter
#define TAxEX0			TIMER_A0->EX0		//expansion divider
#define TAxIV			TIMER_A0->IV		//status register

//compare control registers
#define TAxCCTL0		TIMER_A0->CCTL[0]	//timer a0 ccr0 control register
#define TAxCCTL1		TIMER_A0->CCTL[1]	//timer a0 ccr1 control register
#define TAxCCTL2		TIMER_A0->CCTL[2]	//timer a0 ccr1 control register
#define TAxCCTL3		TIMER_A0->CCTL[3]	//timer a0 ccr1 control register
#define TAxCCTL4		TIMER_A0->CCTL[4]	//timer a0 ccr1 control register
#define TAxCCTL5		TIMER_A0->CCTL[5]	//timer a0 ccr1 control register
#define TAxCCTL6		TIMER_A0->CCTL[6]	//timer a0 ccr1 control register
//compare period registers
#define TAxCCR0			TIMER_A0->CCR[0]	//timer a0 ccr0 period register
#define TAxCCR1			TIMER_A0->CCR[1]	//timer a0 ccr1 period register
#define TAxCCR2			TIMER_A0->CCR[2]	//timer a0 ccr1 period register
#define TAxCCR3			TIMER_A0->CCR[3]	//timer a0 ccr0 period register
#define TAxCCR4			TIMER_A0->CCR[4]	//timer a0 ccr1 period register
#define TAxCCR5			TIMER_A0->CCR[5]	//timer a0 ccr1 period register
#define TAxCCR6			TIMER_A0->CCR[6]	//timer a0 ccr0 period register
...
void tmra0_init(uint16_t ps) {
	...
	TAxCTL	=	TASSEL_2 |			//0->TAxCLK, 1->ACLK, 2->SMCLK, 3->INCLK
				...
				(0<<1) |			//0->TAIE disabled, 1->TAIE enabled
				(0<<1);				//TAIFG flag
	TAxCCR0 = 0xffff;				//set top
#if defined(TAxEX0)
...
void tmra0_setpr0(uint16_t pr) {
	...
	TAxCCTL0 =		CM_0 |			//0b00->no capture; 0b01->on rising edge; 0b10->on falling edge; 0b11->on rising and falling edges
...
void tmra0_act0(void (*isrptr)(void)) {
	...
	NVIC_EnableIRQ(TA0_0_IRQn);		//enable interrupt for timer0_ccr0
}
...
void tmra0_act1(void (*isrptr)(void)) {
	...
	NVIC_EnableIRQ(TA0_N_IRQn);		//enable interrupt for timer0_ccr0
}
