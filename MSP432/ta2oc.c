...
//global defines
#define TAxCTL			TIMER_A2->CTL		//timer a0 control register
#define TAxR			TIMER_A2->R			//timer counter
#define TAxEX0			TIMER_A2->EX0		//expansion divider
#define TAxIV			TIMER_A2->IV		//status register

//compare control registers
#define TAxCCTL0		TIMER_A2->CCTL[0]	//timer a0 ccr0 control register
#define TAxCCTL1		TIMER_A2->CCTL[1]	//timer a0 ccr1 control register
#define TAxCCTL2		TIMER_A2->CCTL[2]	//timer a0 ccr1 control register
#define TAxCCTL3		TIMER_A2->CCTL[3]	//timer a0 ccr1 control register
#define TAxCCTL4		TIMER_A2->CCTL[4]	//timer a0 ccr1 control register
#define TAxCCTL5		TIMER_A2->CCTL[5]	//timer a0 ccr1 control register
#define TAxCCTL6		TIMER_A2->CCTL[6]	//timer a0 ccr1 control register
//compare period registers
#define TAxCCR0			TIMER_A2->CCR[0]	//timer a0 ccr0 period register
#define TAxCCR1			TIMER_A2->CCR[1]	//timer a0 ccr1 period register
#define TAxCCR2			TIMER_A2->CCR[2]	//timer a0 ccr1 period register
#define TAxCCR3			TIMER_A2->CCR[3]	//timer a0 ccr0 period register
#define TAxCCR4			TIMER_A2->CCR[4]	//timer a0 ccr1 period register
#define TAxCCR5			TIMER_A2->CCR[5]	//timer a0 ccr1 period register
#define TAxCCR6			TIMER_A2->CCR[6]	//timer a0 ccr0 period register
...
void tmra2_act0(void (*isrptr)(void)) {
	_tmrx_ccr0isrptr = isrptr;		//install user handler
	TAxCCTL0 |= (1<<4);				//enable interrupt
	NVIC_EnableIRQ(TA2_0_IRQn);		//enable interrupt for timer0_ccr0
}

//initialize tmra_ccr1
void tmra2_setpr1(uint16_t pr) {
...
void tmra2_act1(void (*isrptr)(void)) {
	_tmrx_ccr1isrptr = isrptr;		//install user handler
	TAxCCTL1 |= (1<<4);				//enable interrupt
	NVIC_EnableIRQ(TA2_N_IRQn);		//enable interrupt for timer0_ccr0
}

//initialize tmra_ccr2
void tmra2_setpr2(uint16_t pr) {
...
void tmra2_act2(void (*isrptr)(void)) {
...
void tmra2_act3(void (*isrptr)(void)) {
...
void tmra2_act4(void (*isrptr)(void)) {
...
void tmra2_act5(void (*isrptr)(void)) {
...
void tmra2_act6(void (*isrptr)(void)) {
