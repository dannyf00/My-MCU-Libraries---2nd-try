...
//global defines
#define CTx				LPC_TMR16B0	//16bix timer0
...
void tmr16b0_setpr0(uint32_t match/*, uint32_t config*/) {
...
void tmr16b0_setpr1(uint32_t match/*, uint32_t config*/) {
	//enable timer interrupt on match
...
void tmr16b0_setpr2(uint32_t match/*, uint32_t config*/) {
	//enable timer interrupt on match
...
void tmr16b0_setpr3(uint32_t match/*, uint32_t config*/) {
	//enable timer interrupt on match
...
uint32_t tmr16b0_getpr0(void) {
	return CTx->MR0;
}

//get match register value - ch1
uint32_t tmr16b0_getpr1(void) {
	return CTx->MR1;
}

//get match register value - ch2
uint32_t tmr16b0_getpr2(void) {
	return CTx->MR2;
}

//get match register value - ch3
uint32_t tmr16b0_getpr3(void) {
	return CTx->MR3;
}
