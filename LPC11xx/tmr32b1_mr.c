...
#include "tmr32b1_mr.h"				//we use tmr32b0

//hardware configuration
//end hardware configuration

//global defines
#define CTx				LPC_TMR32B1	//16bix timer0
...
uint32_t tmr32b1_getpr0(void) {
	return CTx->MR0;
}

//get match register value - ch1
uint32_t tmr32b1_getpr1(void) {
	return CTx->MR1;
}

//get match register value - ch2
uint32_t tmr32b1_getpr2(void) {
	return CTx->MR2;
}

//get match register value - ch3
uint32_t tmr32b1_getpr3(void) {
	return CTx->MR3;
}
