#include "led3_pins.h"				  //we use 4-digit 7-segment leds
...
//#define LED_DIG4		LED4_PIN6			//not connected
...
#endif
unsigned char lRAM[3];				//led display buffer
//led font.
//SEGDOT = 0x80
//SEGG   = 0x40
//SEGF   = 0x20
...
void led_display(void) {
	...
	switch (dig) {
		...
		case 1: DIG_ON(LED_DIG2); dig=2; break;
		case 2: DIG_ON(LED_DIG3); dig=0; break;
		//case 3: DIG_ON(LED_DIG4); dig=0; break;
