#ifndef __LCD_HC164_H
#define __LCD_HC164_H
...
#define LCD_PORT		PD_ODR			//lcd pins on portc
#define LCD_DIR			PD_DDR		//output direction
#define LCD_EN			(1<<5)		//LCD_EN on RC5
#define LCD_RS			(1<<4)		//lcd_rs pin

//spi pins specified in the spi library
//#define LCD_CLK			(1<<3)		//LCD_CLK on RC6
//#define LCD_SI			(1<<1)		//spi data in on RC7
...
//#define init_ctrl()		IO_OUT(LCD_DIR, LCD_EN | LCD_RS)	//LCD_RS, LCD_EN, LCD_RS and LCD_CLK in output mode
