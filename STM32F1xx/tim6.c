#include "tim6.h"					//using timer output compare channels as timer

//hardware configuration
//end hardware configuration

//global defines
#define RCC_APB1ENR_TIMxEN				RCC_APB1ENR_TIM6EN
#define TIMx							TIM6
...
//global variables
static void (* _tim_isrptr)(void)=empty_handler;				//tim6_ptr pointing to empty_handler by default
...
void tim6_init(uint32_t ps) {
	...
	TIMx->CR2  = TIM_CR2_MMS_0;			//master mode selection on reset
