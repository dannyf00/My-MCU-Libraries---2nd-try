#include "tim1oc.h"					//using timer output compare channels as timer

//hardware configuration
//end hardware configuration

//global defines
#define RCC_APB2ENR_TIMxEN				RCC_APB2ENR_TIM1EN
#define TIMx							TIM1
...
static void (* _tim_oc4isrptr)(void)=empty_handler;				//tim1_ptr pointing to empty_handler by default
