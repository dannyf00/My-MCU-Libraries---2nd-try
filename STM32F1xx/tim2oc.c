#include "tim2oc.h"					//using timer output compare channels as timer
...
//global variables
static void (* _tim_ovfisrptr)(void)=empty_handler;				//tim2_ptr pointing to empty_handler by default
static void (* _tim_oc1isrptr)(void)=empty_handler;				//tim2_ptr pointing to empty_handler by default
static void (* _tim_oc2isrptr)(void)=empty_handler;				//tim2_ptr pointing to empty_handler by default
static void (* _tim_oc3isrptr)(void)=empty_handler;				//tim2_ptr pointing to empty_handler by default
static void (* _tim_oc4isrptr)(void)=empty_handler;				//tim2_ptr pointing to empty_handler by default
