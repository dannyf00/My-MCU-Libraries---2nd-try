#include "whetstone.h"					//we use whetstone
//global defines

//global variables

//whetstone configuration
//#define WHETSTONE_LOOP		1			//number of loops to run
//end whetstone configuration
...
whetstone(void)
{
	...
	loopstart = WHETSTONE_LOOP;			//1000;		/* see the note about LOOP below */
	continuous = 0;						//0=don't run it continuously
