...
//#define LED4_PIN6			GPIOA->B5
#define LED4_PIN7			GPIOB->B1
#define LED4_PIN8			GPIOB->B2
#define LED4_PIN9			GPIOB->B3
#define LED4_PIN10			GPIOB->B4
#define LED4_PIN11			GPIOB->B5
#define LED4_PIN12			GPIOB->B6
