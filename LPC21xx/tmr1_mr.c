#include "tmr1_mr.h"				//we use tmr0 match compare

//hardware configuration
//end hardware configuration

//global defines
#define CTx				CT1			//timer in use
#define CTx_IRQn		(1<<5)		//4=TIMER0, 5=TIMER1, 6=UART0, 7=UART1
#define CTx_VICx		5			//vic channel. needs to be unique
#define VICVectAddrx	VICVectAddr5	  	//determined by CTx_VICx
#define VICVectCntlx	VICVectCntl5		//deterlimined by CTx_VICx
...
void tmr1_act0(void (*isr_ptr)(void)) {
	...
	VICVectAddrx = (uint32_t) T1ISR;	//slot to contain isr address
