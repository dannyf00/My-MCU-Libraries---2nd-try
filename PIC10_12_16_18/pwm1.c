//#include "gpio.h"
#include "pwm1.h"								//we use pwm1/ccp1

//hardware configuration
//pwm registers
#define PWMx_DDR			TRISC
#define PWMx				(1<<5)			//will need to reconfigure P1M1/P1M0 in CCPxCON
...
//set pwm period
void pwm1_setpr(unsigned char prescaler, unsigned short period) {
	//set the period
	switch (_tmr_used) {
	...
	//depending on output pin configuration, may need to set/clear P1M1/P1M0
}
