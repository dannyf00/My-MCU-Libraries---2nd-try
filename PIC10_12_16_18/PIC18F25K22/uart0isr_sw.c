#include "uart0isr_sw.h"						//we use software uart / interrupt driven, timer2 as timebase, tx only
...
void uart0_init(uint32_t bps) {
	...
	if (F_UART <= bps * 256 * 1) {
		...
		PSA=0, T0PS2=0, T0PS1=0, T0PS0=0;			//PS2..0=0b000->2:1prescaler
		...
		PSA=0, T0PS2=0, T0PS1=0, T0PS0=1;			//PS2..0=0b001->4:1prescaler
