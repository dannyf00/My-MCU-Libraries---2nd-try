//#include "gpio.h"
#include "pwm4.h"								//we use pwm1/ccp1

//hardware configuration
//pwm registers
#define PWMx_DDR			TRISB
#define PWMx				(1<<0)
#define PWMx_TMR			PWM_USE_TMR1		//tmr1/3/5
...
//set pwm period
void pwm4_setpr(unsigned char prescaler, unsigned short period) {
	//set the period
	switch (_tmr_used) {
